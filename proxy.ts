...
export const config = {
  matcher: ["/market/:path*", "/properties/:path*", "/districts/:path*", "/gangs/:path*", "/profile/:path*", "/owner/:path*", "/support/:path*", "/account/:path*", "/seasons/:path*", "/players/:path*", "/staff/:path*", "/community/:path*", "/dashboard/:path*", "/update-password", "/api/:path*", "/auth/:path*"],
};
