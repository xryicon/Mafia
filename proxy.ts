...
export const config = {
  matcher: ["/chop-shop/:path*", "/warehouses/:path*", "/skills/:path*", "/shooting-range/:path*", "/crafting/:path*", "/refineries/:path*", "/bin-diving/:path*", "/telegrams/:path*", "/ledger/:path*", "/market/:path*", "/properties/:path*", "/districts/:path*", "/gangs/:path*", "/profile/:path*", "/owner/:path*", "/support/:path*", "/account/:path*", "/seasons/:path*", "/players/:path*", "/staff/:path*", "/community/:path*", "/dashboard/:path*", "/update-password", "/api/:path*", "/auth/:path*"],
};
