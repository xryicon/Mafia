...
Movement follows street crossings and has server-validated travel time. Search actions require arrival at that exact location, an open district and season, and no active search or shared loot cooldown. A searched location remains depleted through navigation and refresh. Sessions and sites are season-scoped; history is retained.
