...
async function enterStreet(page:Page){const enter=page.getByRole("button",{name:/^Enter /});if(await enter.count())await enter.click();await expect(page.locator(".simple-scav-grid")).toBeVisible();}
