...
console.log(JSON.stringify({commandDashboardDeployed,sharedCommandHudDeployed:styles.includes(".command-city.command-dashboard-page"),cityWideOfficeMarkerRemoved:!styles.includes(".command-office-marker")}));
