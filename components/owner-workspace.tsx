...
export const ownerSections=[["overview","Control room"],["moderation","Player moderation"],["roles","Roles & permissions"],["districts","Districts & properties"],["economy","Economy & production"],["adjustments","Money & assets"],["seasons","Seasons & leaderboards"],["tickets","Support tickets"],["evidence","Sanctions & evidence"],["chat","Chat moderation"],["audit","Audit history"]];
