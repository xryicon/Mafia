...
export async function GamePage({path,view,good,district}:{path:string;view:GameView;good?:string;district?:string}){
 ...
 return <GameShell initial={state} initialTab={view} initialDistrict={district} initialGood={state.goods.some(g=>g.id===good)?good:undefined}/>;
}
