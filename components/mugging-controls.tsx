...
export function MuggingControls(){
 ...
 return <section className="robbery-controls" aria-label="Mugging">
  ...
  <RobberyPanel data={data} now={now} busy={busy||!!retry} blocked={!!retry} act={(action,payload)=>retry?Promise.resolve(false):run(action,payload)}/>
