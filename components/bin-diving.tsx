...
export function BinDiving({initial,initialDistrict}:{initial:BinState;initialDistrict?:string}){
 ...
 <div className="bin-breadcrumb"><Link href="/dashboard">← Dashboard</Link><span>/</span><Link href="/gang-wars">Gang Wars · 3D practice</Link><span>/ SCAVENGING</span>{data.can_manage&&<Link className="bin-owner-link" href="/owner?section=bin-diving">Owner controls ↗</Link>}</div>
