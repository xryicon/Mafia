...
export function BinDiving({initial,initialDistrict}:{initial:BinState;initialDistrict?:string}){
 ...
 <ScavengingMap state={data.scavenging} district={district} now={h.now} busy={h.busy} blocked={!playable||!data.rules.enabled||closed} cooldown={seconds} lockpicks={data.inventory.lockpick??0} act={h.act}/>
 </div>
