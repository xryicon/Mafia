export type Good = { id: string; name: string; business_name: string; business_available?: boolean; business_available?: boolean; business_cost: number; batch_size: number; cycle_seconds: number };
