...
export type Pursuit={id:string;vehicle_id:string|null;vehicle_name:string;kind?:"foot";tracking?:"chasing"|"searching";started_at:string;grace_until:string;deadline:string;exit_node:number;patrols:PolicePatrol[];next_shot_at:string;rules:Record<string,number>};
