...
const destinations = ["/bin-diving", "/telegrams", "/ledger", "/dashboard", "/market", "/properties", "/districts", "/gangs", "/profile", "/update-password", "/staff", "/owner", "/community", "/support", "/seasons", "/players", "/account"];
