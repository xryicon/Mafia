...
const destinations = ["/skills","/shooting-range","/crafting", "/inventory","/warehouses", "/bank", "/refineries", "/bin-diving", "/telegrams", "/ledger", "/dashboard", "/market", "/properties", "/districts", "/gangs", "/profile", "/update-password", "/staff", "/owner", "/community", "/support", "/seasons", "/players", "/account"];
